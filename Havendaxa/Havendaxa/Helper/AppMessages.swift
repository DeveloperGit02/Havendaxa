...
class AppMessages {
    ...
    //static let MSG_PHONE_NUMBER_EMPTY = "Please enter the phone number."
    static let MSG_PHONE_NUMBER_INVALID = "Please enter a valid phone number."
    static let MSG_API_FAILURE = "Something went wrong!"
